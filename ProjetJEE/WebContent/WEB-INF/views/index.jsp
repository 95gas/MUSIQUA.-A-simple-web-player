...
<body>
  ...
  <section id="content" class="albumSingle padding background-properties"  style="background-color:#E3E4E6">
    <div class="container" style="padding-left:0; padding-right:0;">
      <div class="sectionTitle paddingBottom">
        <span class="heading-t3"></span>
        <h2><a> Top songs of the month</a></h2>
        <span class="heading-b3"></span>
      </div><!-- end sectionTtile -->

      <div class="row">
        <div class="col-sm-8_home">
          <div id="post-59" class="jp-playlist post-59 albums type-albums status-publish has-post-thumbnail hentry albums-category-new">
            ...
            <div class="trak-item" data-audio="http://theme-brothers.com/wp-content/uploads/2016/06/1.mp3" data-artist="Yuna" data-thumbnail="resources/img/content/cover2.jpg" >
              ...
              <time class="trak-duration" datetime="2016-06-02">4:55</time>
            </div>
