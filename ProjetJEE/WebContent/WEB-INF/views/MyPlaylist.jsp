...
<head>
      ...
      <link href="resources/css/playlist.css" rel="stylesheet" type="text/css" media="all"/>
   ...
   <body style="background-image: url(resources/assets/img/wall1.png);">
      ...
      <header class="header default">
         ...
         <div class="middle-part">
           ...
           <div class="button" id="button-playlist" style="background-color: #BFC0C0">
             <div id="circle"></div>
              ...
              <div class="row">
                 <div class="col_playlist">
                    <div class="block-content">
                       <h5 class="uppercase">Playlist 1</h5>
                       <h3>#songs</h3>
                       <a href="#">
                       <img class="animated" src="resources/assets/img/playlist/1.jpg" alt="">
                       </a>
                       <ul class="block-social list-inline ">
                          <li class="list-inline-item mr-0"><a href="#"><i class="fas fa-share-alt"></i></a></li>
                          <li class="list-inline-item mr-0"><a href="#"><i class="far fa-trash-alt"></i></a></li>
                          <li class="list-inline-item mr-0"><a href="#"><i class="fas fa-pen"></i></a></li>
                       </ul>
                    </div>
                 </div>
                 <div class="col_playlist">
                    <div class="block-content">
                       <h5 class="uppercase">Playlist 2</h5>
                        <h3>#songs</h3>
                       <a href="#">
                       <img class="animated" src="resources/assets/img/playlist/2.jpg" alt="">
                       </a>
                       <ul class="block-social list-inline ">
                          <li class="list-inline-item mr-0"><a href="#"><i class="fas fa-share-alt"></i></a></li>
                          <li class="list-inline-item mr-0"><a href="#"><i class="far fa-trash-alt"></i></a></li>
                 ...
                 <div class="col_playlist">
                    <div class="block-content">
                       <h5 class="uppercase">Playlist 3</h5>
                        <h3>#songs</h3>
                       <a href="#">
                       <img  class="animated" src="resources/assets/img/playlist/3.jpg" alt="">
                       </a>
                       <ul class="block-social list-inline ">
                          <li class="list-inline-item mr-0"><a href="#"><i class="fas fa-share-alt"></i></a></li>
                          <li class="list-inline-item mr-0"><a href="#"><i class="far fa-trash-alt"></i></a></li>
                 ...
                 <div class="col_playlist">
                       <a href="#">
                       <i class="fas fa-plus" id='add_playlist'></i>
                       </a>
                 </div>
              </div>
              <!--End row-->
